                    ...
                    @foreach($posts as $post)
                        <div class="col-lg-4 col-md-4">
                            <div class="fh5co-blog animate-box">
                                <a href="{{ asset(\LaraCurso\Suporte\Cropper::thumb($post->cover, 800, 450)) }}"><img class="img-responsive" src="{{ asset(\LaraCurso\Suporte\Cropper::thumb($post->cover, 800, 450)) }}" alt=""></a>
                                <div class="blog-text">
